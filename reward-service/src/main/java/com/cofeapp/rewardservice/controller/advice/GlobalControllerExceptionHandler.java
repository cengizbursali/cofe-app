package com.cofeapp.rewardservice.controller.advice;

import com.cofeapp.rewardservice.exception.RewardServiceException;
import com.cofeapp.rewardservice.model.error.ErrorResponse;
...
public class GlobalControllerExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUserServiceException(RewardServiceException exception) {
        final String defaultMessage = "RewardServiceException occurred.";
        final ErrorResponse errorResponse = ErrorResponse.builder()
                .exception("RewardServiceException")
