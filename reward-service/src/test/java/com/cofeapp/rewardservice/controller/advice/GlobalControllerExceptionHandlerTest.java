...
import com.cofeapp.rewardservice.MessageSourceTestConfiguration;
...
public class GlobalControllerExceptionHandlerTest {
    ...
    public void it_should_resolve_userServiceException() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.exception", is("RewardServiceException")))
                .andExpect(jsonPath("$.errors[0]", is("Reward not found.")))
                .andExpect(jsonPath("$.timestamp", notNullValue()));
    }
...
class TestController {
    ...
    public void throwUserServiceException() {
        throw new RewardServiceException("reward.not.found", HttpStatus.NOT_FOUND);
    }
